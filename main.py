...
def main(calibration_matrix_path: str, monitor_mm=None, monitor_pixels=None, model=None, visualize_preprocessing=False, visualize_laser_pointer=True, visualize_3d=False):
    ...
    for frame_idx, frame in enumerate(source):
        ...
        if results.multi_face_landmarks:
            ...
            background = cv2.imread('./data/emotion_2.jpg')
            if visualize_laser_pointer:
                display = np.ones((monitor_pixels[1], monitor_pixels[0], 3), np.float32)
                dim = (monitor_pixels[0], monitor_pixels[1])
                ...
                for idx in range(1, len(gaze_points)):
                    thickness = round((len(gaze_points) - idx) / len(gaze_points) * 5) + 4
                    cv2.line(resized, gaze_points[idx - 1], gaze_points[idx-1], (0, 0, 255), thickness)

                    """
                    if point_on_screen[0] < 683 & point_on_screen[1] < 384:
                        h = h + 10
                        if h == 300:
                            print('Happy')
                            h = 0
                            ...
                            sr = 0
                            print(h, s, f, sr)
                        cv2.putText(resized, '>', (15, 370), font, 2, (0, 0, 255), 2, cv2.LINE_AA)

                    elif point_on_screen[0] > 683 & point_on_screen[1] < 384:
                        print(point_on_screen[0])
                        print(point_on_screen[0])
                        s = s + 10
                        if s == 500:
                            print('Sad')
                            ...
                            sr = 0
                            print(h, s, f, sr)
                        cv2.putText(resized, '>', (730, 370), font, 2, (0, 0, 255), 2, cv2.LINE_AA)
                        ...
                        if f == 300:
                            ...
                            sr = 0
                            print(h, s, f, sr)
                        cv2.putText(resized, '>', (15, 740), font, 2, (0, 0, 255), 2, cv2.LINE_AA)
                        ...
                        if sr == 500:
                            ...
                            sr = 0
                            print(h, s, f, sr)
                        cv2.putText(resized, '>', (730, 740), font, 2, (0, 0, 255), 2, cv2.LINE_AA)
"""
                if frame_idx % 2 == 0:
